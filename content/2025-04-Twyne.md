...
Collateral vault: 100 _ .95 >= 95 -> can't be liquidated
Target vault: 130 _ (80% \* 98%) > 95 -> can't be externally liquidated
...
Collateral vault: 95 _ .95 < 95 -> can be liquidated but liquidator **won't make a profit**
123.5 _ (80% \* 98%) > 95 -> can't be externally liquidated
